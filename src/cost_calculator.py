def calculate_fuel_consumption(
    ...
    for i in range(len(route) - 1):
        ...
        if total_weight == 0:
            ...
            load_ratio = remaining_weight / total_weight

        # Formula konsumsi:
        # kosong = 0.02 liter/km
        # penuh = 0.05 liter/km
        fuel_ratio = 0.02 + 0.03 * load_ratio
        fuel_consumption += distance * fuel_ratio

        # ketika sampai pelanggan, paket dikurangi
...
def calculate_tco(
    ...
    server_cost = exec_time_ms * server_rate
    total_cost = fuel_cost + server_cost
